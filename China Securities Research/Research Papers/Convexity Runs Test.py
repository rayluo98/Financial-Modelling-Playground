# -*- coding: utf-8 -*-
"""
Created on Mon Aug 12 14:37:19 2019
...
sheet1.write(0, 0, "Number of times EMA > original")
...
for k in range(1, obs_no):
    data = [0]*90
    data_change = [0]*90
    Time_period = "[" + str(time[k*shift + 90])[0:10] + "," + str(time[k*shift + 179])[0:10] + "]"
    sheet1.write(k + 1, 1, Time_period)
    Random = False
    for l in range(90):
        data[l] = MA_diff_b[k*shift + l + 90]
        data_change[l] = MA_diff_change[k*shift + l + 90]
...
sheet2.write(0, 0, "number of increases for EMA")
...
for k in range(1, obs_no):
    ...
    Random = False
    for l in range(89):
        data[l] = binary[k*shift + l + 90]
        data_change[l] = binary_change[k*shift + l + 90]
    data[89] = binary[k*shift + 179]
